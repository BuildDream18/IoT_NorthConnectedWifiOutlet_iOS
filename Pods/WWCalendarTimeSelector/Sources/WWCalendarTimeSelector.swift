...
//    open var optionCalendarBackgroundColorTodayHighlight = UIColor.brown
    open var optionCalendarBackgroundColorTodayHighlight = UIColor(hex: "#29C6A7FF")
...
//    open var optionCalendarBackgroundColorPastDatesHighlight = UIColor.brown
    open var optionCalendarBackgroundColorPastDatesHighlight = UIColor(hex: "#29C6A7FF")
...
//    open var optionCalendarBackgroundColorFutureDatesHighlight = UIColor.brown
    open var optionCalendarBackgroundColorFutureDatesHighlight = UIColor(hex: "#29C6A7FF")
...
//    open var optionClockBackgroundColorAMPMHighlight = UIColor.brown
    open var optionClockBackgroundColorAMPMHighlight = UIColor(hex: "#29C6A7FF")
    open var optionClockFontHour = UIFont.systemFont(ofSize: 18)
...
//    open var optionClockBackgroundColorHourHighlightNeedle = UIColor.brown
    open var optionClockBackgroundColorHourHighlight = UIColor(hex: "#29C6A7FF")
    open var optionClockBackgroundColorHourHighlightNeedle = UIColor(hex: "#29C6A7FF")
    open var optionClockFontMinute = UIFont.systemFont(ofSize: 16)
    open var optionClockFontMinuteHighlight = UIFont.systemFont(ofSize: 16)
...
//    open var optionClockBackgroundColorMinuteHighlightNeedle = UIColor.brown
    open var optionClockBackgroundColorMinuteHighlight = UIColor(hex: "#29C6A7FF")
    open var optionClockBackgroundColorMinuteHighlightNeedle = UIColor(hex: "#29C6A7FF")
    ...
    open var optionButtonFontCancel = UIFont.systemFont(ofSize: 20)
    open var optionButtonFontDone = UIFont.boldSystemFont(ofSize: 20)
//    open var optionButtonFontColorCancel = UIColor.brown
//    open var optionButtonFontColorDone = UIColor.brown
    open var optionButtonFontColorCancel = UIColor(hex: "#29C6A7FF")
    open var optionButtonFontColorDone = UIColor(hex: "#29C6A7FF")
...
//    open var optionTopPanelBackgroundColor = UIColor.brown
    open var optionTopPanelBackgroundColor = UIColor(hex: "#29C6A7FF")
...
//    open var optionSelectorPanelBackgroundColor = UIColor.brown.withAlphaComponent(0.9)
    open var optionSelectorPanelBackgroundColor = UIColor(hex: "#29C6A7FF")!.withAlphaComponent(0.9)
...
//    fileprivate var tintColor : UIColor! = UIColor.brown
    fileprivate var tintColor : UIColor! = UIColor(hex: "#29C6A7FF")
    ...
    public static func instantiate() -> WWCalendarTimeSelector {
        ...
        return UIStoryboard(name: "WWCalendarTimeSelector", bundle: nil).instantiateInitialViewController() as! WWCalendarTimeSelector
    }
